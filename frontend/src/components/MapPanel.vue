...
const navigationDebug = computed(() => state.value?.navigation?.debug_status || null)
  ...
  <section class="map-section">
    ...
    <div class="map-workflow-grid">
      <div>
        ...
        <div v-if="navigationDebug" class="nav-debug-status" :class="navigationDebug.level">
          <strong>{{ navigationDebug.label }}</strong>
          <span>{{ navigationDebug.detail }}</span>
        </div>
